...
export const observationTypeOptions = [
  //label, value
  {
    label: 'OM_Measurement',
    value:
      'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_Measurement',
  },
  {
    label: 'OM_CategoryObservation',
    value:
      'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_CategoryObservation',
  },
  {
    label: 'OM_CountObservation',
    value:
      'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_CountObservation',
  },
  {
    label: 'OM_Observation',
    value:
      'http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_Observation',
  },
  {
    label: 'OM_TruthObservation',
    value:
...
export function buildDatastreamFields(params: {
  ...
  const base = [
    {
      ...
      required: true,
      defaultValue: 'New Datastream',
    },
    {
      name: 'description',
      label: t('datastreams.description'),
      required: false,
      defaultValue: 'Datastream Description',
    },
    {
  ...
  if (includePhenomenonTime) {
    return [
      ...
      {
        name: 'phenomenonTime',
        label: t('datastreams.phenomenon_time'),
        type: 'datetime-local',
        required: false,
      },
    ]
