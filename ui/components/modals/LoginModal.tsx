      ...
      >
        ...
        >
          <Link isExternal aria-label="istSOS4" href={siteConfig.links.istSOS}>
            <div style={{ width: 150, height: "auto", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
        ...
        <div style={{ padding: "50px", width: "100%" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <a
                href="#"
                style={{ color: siteConfig.main_color, textDecoration: "none", fontSize: "14px" }}
              >
                Need help?
              </a>
              <Button
